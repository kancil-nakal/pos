                        ...
                        foreach ($row as $key => $data) : ?>
                            <tr>
                                ...
                                <td class="text-center float">
                                    <a href="" class="btn btn-xs btn-info" ><i class="fa fa-eye"></i> Detail</a>
                                    <a href="<?= base_url('stock/in/delete/' . $data->stock_id); ?>" class="btn btn-xs btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i> Delete</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
